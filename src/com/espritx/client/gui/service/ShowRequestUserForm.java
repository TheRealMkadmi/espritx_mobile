...
public class ShowRequestUserForm extends BaseForm {
    public ShowRequestUserForm() {
        this(Resources.getGlobalResources());
    }

    public ShowRequestUserForm(Resources resourceObjectInstance) {
    ...
    private void initUserControls(Resources resourceObjectInstance) {
        List<Request> requestList = RequestService.GetUserRequests();
