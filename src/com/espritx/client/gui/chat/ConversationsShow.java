...
for (Conversation conver : listeConver) {
            ...
            if(conver.participants.get(0).id.getInt()== AuthenticationService.getAuthenticatedUser().id.getInt()){MultiButton mb = new MultiButton(conver.participants.get(1).first_name.get());
            ...
            else {MultiButton mb = new MultiButton(conver.participants.get(0).first_name.get());
                mb.setInlineStylesTheme(resourceObjectInstance);
